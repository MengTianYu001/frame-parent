...
public final class TypeUtils {
    ...
    public static Type resolveReturnType(Type baseType, Type overridingType) {
        ...
        } else if (baseType instanceof Class && overridingType instanceof ParameterizedType) {
            return overridingType;
        } else {
            return baseType instanceof Class && overridingType instanceof TypeVariable ? overridingType : baseType;
        }
    }
